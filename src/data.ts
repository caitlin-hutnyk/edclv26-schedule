...
export const day1Acts: Act[] = [
  ...
  { id: 'd1-kf-chainsmoker', name: 'The Chainsmokers', stage: 'kinetic', start: t(24, 32), end: t(25, 42) },
  { id: 'd1-kf-fisher', name: 'Fisher', stage: 'kinetic', start: t(25, 47), end: t(26, 57) },
  { id: 'd1-kf-porter', name: 'Porter Robinson', stage: 'kinetic', start: t(27, 1), end: t(28, 11) },
  { id: 'd1-kf-charlotte', name: 'Charlotte De Witte', stage: 'kinetic', start: t(28, 14), end: t(29, 29) },

  // circuitGROUNDS
  { id: 'd1-cg-1991', name: '1991', stage: 'circuit', start: t(19, 0), end: t(20, 0) },
  { id: 'd1-cg-bou', name: 'Bou', stage: 'circuit', start: t(20, 0), end: t(21, 0) },
  ...
  { id: 'd1-cg-levity', name: 'Levity', stage: 'circuit', start: t(23, 15), end: t(24, 25) },
  ...
  { id: 'd1-cm-notion', name: 'Notion', stage: 'cosmic', start: t(25, 47), end: t(26, 47) },
  { id: 'd1-cm-mph', name: 'MPH', stage: 'cosmic', start: t(26, 47), end: t(28, 2) },
  ...
  { id: 'd1-bp-muzz', name: 'Muzz', stage: 'bass', start: t(20, 40), end: t(21, 30) },
  ...
  { id: 'd1-bp-culture-shock', name: 'Culture Shock', stage: 'bass', start: t(27, 30), end: t(28, 30) },
  ...
  { id: 'd1-ng-adriatique', name: 'Adriatique', stage: 'neon', start: t(25, 0), end: t(26, 30) },
  ...
  { id: 'd1-bj-salute-chloe', name: 'Salute B2B Chloe Caillet', stage: 'bionic', start: t(24, 30), end: t(26, 30) },
...
export const day2Acts: Act[] = [
  ...
  { id: 'd2-kf-sub-focus', name: 'Sub Focus', stage: 'kinetic', start: t(21, 0), end: t(22, 0) },
  ...
  { id: 'd2-kf-john-summit', name: 'John Summit', stage: 'kinetic', start: t(24, 32), end: t(25, 42) },
  { id: 'd2-kf-subtronics', name: 'Subtronics', stage: 'kinetic', start: t(25, 47), end: t(26, 57) },
  { id: 'd2-kf-kaskade', name: 'Kaskade', stage: 'kinetic', start: t(27, 1), end: t(28, 11) },
  { id: 'd2-kf-above-beyond', name: 'Above & Beyond', stage: 'kinetic', start: t(28, 14), end: t(29, 29) },
  ...
  { id: 'd2-cg-kettama', name: 'Kettama', stage: 'circuit', start: t(21, 15), end: t(22, 45) },
  { id: 'd2-cg-sammy-virji', name: 'Sammy Virji', stage: 'circuit', start: t(22, 45), end: t(24, 15) },
  { id: 'd2-cg-tiesto', name: 'Tiësto', stage: 'circuit', start: t(24, 15), end: t(25, 45) },
  ...
  { id: 'd2-cm-bunt', name: 'Bunt.', stage: 'cosmic', start: t(24, 40), end: t(26, 10) },
  ...
  { id: 'd2-bp-hybrid-minds', name: 'Hybrid Minds', stage: 'bass', start: t(21, 30), end: t(22, 30) },
  { id: 'd2-bp-ydg', name: 'YDG', stage: 'bass', start: t(22, 30), end: t(23, 30) },
  { id: 'd2-bp-delta-heavy', name: 'Delta Heavy', stage: 'bass', start: t(23, 30), end: t(24, 30) },
  ...
  { id: 'd2-bp-doctor-flux-funtcase', name: 'Doctor P B2B Flux Pavilion B2B Funtcase', stage: 'bass', start: t(26, 30), end: t(27, 30) },
  { id: 'd2-bp-hol', name: 'Hol!', stage: 'bass', start: t(27, 30), end: t(28, 30) },
  { id: 'd2-bp-mary-droppinz', name: 'Mary Droppinz', stage: 'bass', start: t(28, 30), end: t(29, 30) },
  ...
  { id: 'd2-ng-prospa', name: 'Prospa', stage: 'neon', start: t(25, 30), end: t(27, 30) },
...
export const day3Acts: Act[] = [
  ...
  { id: 'd3-kf-layton', name: 'Layton Giordani', stage: 'kinetic', start: t(21, 0), end: t(22, 0) },
  { id: 'd3-kf-funk-tribu', name: 'Funk Tribu', stage: 'kinetic', start: t(22, 7), end: t(23, 15) },
  { id: 'd3-kf-griz-wooli', name: 'Griz B2B Wooli', stage: 'kinetic', start: t(23, 19), end: t(24, 29) },
  { id: 'd3-kf-zedd', name: 'Zedd', stage: 'kinetic', start: t(24, 32), end: t(25, 42) },
  { id: 'd3-kf-martin-garrix', name: 'Martin Garrix', stage: 'kinetic', start: t(25, 47), end: t(26, 57) },
  { id: 'd3-kf-cloonee', name: 'Cloonee', stage: 'kinetic', start: t(27, 1), end: t(28, 11) },
  { id: 'd3-kf-armin', name: 'Armin van Buuren', stage: 'kinetic', start: t(28, 14), end: t(29, 29) },
  ...
  { id: 'd3-cg-solomun', name: 'Solomun', stage: 'circuit', start: t(25, 0), end: t(26, 30) },
  ...
  { id: 'd3-cm-dabin', name: 'Dabin', stage: 'cosmic', start: t(23, 0), end: t(24, 5) },
  { id: 'd3-cm-alison-wonderland', name: 'Alison Wonderland', stage: 'cosmic', start: t(24, 5), end: t(25, 5) },
  { id: 'd3-cm-seven-lions', name: 'Seven Lions', stage: 'cosmic', start: t(25, 5), end: t(26, 20) },
  { id: 'd3-cm-restricted', name: 'Restricted', stage: 'cosmic', start: t(26, 20), end: t(27, 20) },
  { id: 'd3-cm-btsm', name: 'Black Tiger Sex Machine', stage: 'cosmic', start: t(27, 20), end: t(28, 30) },
  ...
  { id: 'd3-bp-amc', name: 'A.M.C', stage: 'bass', start: t(22, 30), end: t(23, 30) },
  ...
  { id: 'd3-bp-aeon-mode', name: 'AEON:MODE', stage: 'bass', start: t(28, 30), end: t(29, 30) },
  ...
  { id: 'd3-sb-silva-bumpa', name: 'Silva Bumpa', stage: 'stereo', start: t(26, 15), end: t(27, 30) },
  { id: 'd3-sb-morgan-seatree', name: 'Morgan Seatree', stage: 'stereo', start: t(27, 30), end: t(28, 30) },
