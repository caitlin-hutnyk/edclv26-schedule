...
export const day3Acts: Act[] = [
  ...
  { id: 'd3-bp-peekaboo', name: 'Peekaboo', stage: 'bass', start: t(24, 30), end: t(25, 30), tier: 'could' },
  { id: 'd3-bp-ahee-liquid', name: 'Ahee B2B Liquid Stranger', stage: 'bass', start: t(25, 30), end: t(26, 30), tier: 'could' },
  ...
  // wasteLAND
  { id: 'd3-wl-sihk', name: 'Sihk', stage: 'waste', start: t(19, 0), end: t(20, 30), tier: 'could' },
  { id: 'd3-wl-clawz', name: 'Clawz', stage: 'waste', start: t(20, 30), end: t(21, 30), tier: 'could' },
...
export const day3Itinerary: ItineraryBlock[] = [
  {
    type: 'meander',
    title: 'Arrive early · bassPOD',
    start: t(19, 0),
    end: t(22, 30),
    options: [
      { actId: 'd3-wl-sihk', name: 'Sihk', stage: 'WL', time: '7–8:30 PM' },
      { actId: 'd3-wl-clawz', name: 'Clawz', stage: 'WL', time: '8:30–9:30 PM' },
    ],
  },
  {
    type: 'meetup',
  ...
  },
  {
    ...
    options: [
      ...
      { actId: 'd3-bp-peekaboo', name: 'Peekaboo', stage: 'BP', time: '12:30–1:30 AM' },
      { actId: 'd3-cm-seven-lions', name: 'Seven Lions', stage: 'CM', time: '1:05–2:20 AM' },
      { actId: 'd3-bp-ahee-liquid', name: 'Ahee B2B Liquid Stranger', stage: 'BP', time: '1:30–2:30 AM' },
      { actId: 'd3-kf-martin-garrix', name: 'Martin Garrix', stage: 'KF', time: '1:47–2:57 AM' },
      { actId: 'd3-cm-btsm', name: 'Black Tiger Sex Machine', stage: 'CM', time: '3:20–4:30 AM' },
    ],
  },
  { type: 'fireworks', title: 'Fireworks', start: t(25, 40), end: t(25, 40) },
  {
